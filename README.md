...
## Judge Command — Multi-Agent Consensus Analysis

Get second opinions on your work from multiple AI models, synthesized by Opus.
...
- **Worker models**: `zai` and/or `minimax` variants
- **Synthesis**: `claude` command in PATH (for Opus)

```bash
# Create worker variants
